...
export const SectionRowCard = () => {
  return (
    <div className='w-[300px] h-[350px] grid gap-2'>
      <div className="image-container relative p-6 group rounded-md overflow-hidden bg-secondary">
        ...
        <img src="/images/product-img.png" className='w-[220px] mx-auto transition-all  group-hover:scale-90' alt="Product Preview" />
